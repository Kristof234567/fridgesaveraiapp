    ...
    <div className="container flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="flex gap-6 text-sm" style={{ color: 'hsl(var(--footer-fg))' }}>
          <a href="/privacy.html" className="transition-colors hover:text-primary">Privacy Policy</a>
          <Link to="/terms.html" className="transition-colors hover:text-primary">Terms of Use</Link>
        </div>
